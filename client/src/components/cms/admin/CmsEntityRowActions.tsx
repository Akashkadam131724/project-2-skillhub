...
import type { CmsEntityRowActionsProps, CmsEntityStatusBadgeProps } from "./types";

export function CmsEntityStatusBadge({ item }: CmsEntityStatusBadgeProps) {
