...
export function isBannerGradient(value: string) {
  const s = String(value || "").trim().toLowerCase();
  return s.includes("gradient(");
}

export function resolveBannerBg(value: unknown) {
...
export function bannerBgStyle(value: unknown) {
 ...
 */
export function bannerOverlayStyle(
  value: unknown,
