...
import type {
  ...
  ErrorBannerProps,
  FieldProps,
  SectionPreviewThumbProps,
  StatusBadgeProps,
} from "./types";

export function CmsHeading({ title, subtitle, actions }: CmsHeadingProps) {
  return (
...
export function CmsPanel({ title, children, actions, className = "" }: CmsPanelProps) {
  return (
    <section
...
export function StatusBadge({ active, labelOn = "On", labelOff = "Off" }: StatusBadgeProps) {
  return (
    <span
