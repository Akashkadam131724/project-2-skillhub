...
import CardPlaceholder from "@/components/sections/cards/CardPlaceholder";
...
export default function GenericItemPreviewCard({
  ...
  const imgSrc = mediaUrl(item.image_url || item.image || item.icon || "");
