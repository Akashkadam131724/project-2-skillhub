  ...
  return (
    <SectionFrame
      ...
      action={
        <Link
          href="/blogs"
          className="inline-flex items-center gap-2 rounded-full border border-slate-300 bg-white px-4 py-2 text-sm font-semibold section-theme-heading no-underline transition hover:border-brand hover:text-brand"
        >
