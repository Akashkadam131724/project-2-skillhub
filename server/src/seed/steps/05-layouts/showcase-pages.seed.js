/**
 * Platform showcase content pages — hub + capability detail pages.
 *
 *   /showcase
 ...
 *   …
 *
 *   npm run seed:step -- showcase-pages
 */
...
import { allShowcasePageDefs } from "../../lib/showcase-content-pages.js";
...
async function seed() {
  await connectDB();
  console.log("Seeding platform showcase content pages…");
  ...
  const pages = allShowcasePageDefs();
