...
import type { VideoEmbedAttrs } from "./types";
...
export function normalizeVideoEmbed(url: string): VideoEmbedAttrs | null {
...
export function isAllowedVideoSrc(src: string) {
...
export const VideoEmbed = Node.create({
  ...
  addCommands() {
    return {
      setVideoEmbed:
        (attrs: string | VideoEmbedAttrs) =>
        // TipTap command typing doesn't include custom video embed
