...
import CmsListPagination from "@/components/cms/CmsListPagination";
import { CmsPanel, EmptyState } from "@/components/cms/CmsUi";

/**
 * Shared CMS entity list panel — toolbar, rows, and server pagination.
 */
export default function CmsEntityListPanel({
  title,
  items,
  loading,
  total,
