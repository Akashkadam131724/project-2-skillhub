...
import type { BlogAuthor, BlogSummary, BlogTocItem, PrepareBlogContentResult } from "@/lib/types/blog";
 ...
 */
export function prepareBlogContentWithToc(html?: string | null): PrepareBlogContentResult {
