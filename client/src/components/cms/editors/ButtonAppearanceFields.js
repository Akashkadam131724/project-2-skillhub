...
function AppearanceSelect({ field, value, onChange, group }) {
  const label = group?.label || BUTTON_APPEARANCE_FIELD_LABELS[field] || field;
 ...
 */
export default function ButtonAppearanceFields({ value = {}, onChange, onPatch }) {
  const v = value || {};
