...
export default function ContactFormSection({
  ...
  return (
    <SectionBand decor={<SectionBrandGlow />} wrapper>
        ...
        <div className="lg:col-span-5">
          ...
          >
            {section_title || cmsMode ? (
              <h2 className={`mt-3 mb-0 font-[family-name:var(--font-display)] text-3xl leading-tight font-semibold tracking-tight ${DS_TEXT.heading} sm:text-4xl lg:text-[2.65rem]`}>
          ...
          <SectionLightCard className="rounded-[1.75rem] p-5 sm:p-7 lg:p-8">
            ...
            {status === "success" ? (
              ...
              <form onSubmit={onSubmit} className="grid gap-4 sm:grid-cols-2" noValidate>
                ...
                <div className="sm:col-span-2">
                  <label className={`flex items-start gap-3 text-sm leading-relaxed ${DS_TEXT.muted}`}>
                    <input
                      type="checkbox"
