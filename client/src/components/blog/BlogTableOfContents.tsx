...
import type { BlogTableOfContentsProps, BlogTocItem } from "./types";
...
function TocList({ items, activeId, onNavigate, className = "" }: TocListProps) {
  return (
        ...
        {open ? (
          ...
          >
            ...
            <div className="mt-3 max-h-[min(50vh,20rem)] overflow-y-auto">
              <TocList items={items} activeId={activeId} onNavigate={closePopover} />
            </div>
          </div>
        ) : null}
