...
export default function SplitNarrativeSection({
  ...
  return (
    <section className="section-band-shell relative w-full py-12 sm:py-16">
      <SectionWrapper>
          ...
          <header className="mb-10 max-w-3xl sm:mb-14">
            ...
            >
              {section_title || cmsMode ? (
                <h2 className="m-0 font-[family-name:var(--font-display)] text-3xl font-semibold tracking-tight section-theme-heading sm:text-4xl">
                  {section_title || "Story"}
                </h2>
              ) : null}
            </CmsEditable>
            ...
            >
              {sub_title || cmsMode ? (
                <p className="mt-3 mb-0 text-base section-theme-muted">
                  {sub_title || "Subtitle"}
                </p>
              ) : null}
            </CmsEditable>
