...
function nestedTabPair(label: string, title: string, imageUrl: string) {
...
function sampleForKey(key: string) {
  ...
  switch (k) {
    ...
    default:
      return {
        section_title: (SECTION_NAMES as Record<string, string>)[k] || k,
        sub_title: `Preview of the ${k} section.`,
        in_page_nav_title: ((SECTION_NAMES as Record<string, string>)[k] || k).slice(0, 18),
