...
import { SECTION_CATALOG_ENTRIES } from "./section-catalog.entries";
...
export function getSectionCatalogMeta(key?: string) {
...
export function getSectionCatalogMetaByBehavior(behaviorKey?: string) {
