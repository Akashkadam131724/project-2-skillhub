...
import type { HeaderIconButtonProps, HeaderNavSlotProps } from "./types";

function IconButton({ href, label, children }: HeaderIconButtonProps) {
  return (
    <Link
      href={href}
...
function HeaderNavSlot({ mode, navigation, showDesktop, showMobile }: HeaderNavSlotProps) {
  if (mode === "api") {
    return (
      <SiteHeaderNav
