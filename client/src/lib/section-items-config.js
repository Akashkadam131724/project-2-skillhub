...
export const SECTION_ITEMS_CONFIG = {
  ...
  comparison_table: {
    ...
    actionLabel: "rows",
    fields: ["title", "value", "subtitle", "body", "buttons"],
    fieldLabels: {
      title: "Option",
      value: "Highlight",
  ...
  media_mosaic: {
    label: "Mosaic tiles",
    actionLabel: "tiles",
    fields: ["image_url", "title", "subtitle", "buttons"],
    fieldLabels: {
      image_url: "Image",
      title: "Title",
      subtitle: "Caption",
  ...
  timeline_vertical: {
    ...
    fields: ["title", "subtitle", "body", "buttons"],
    fieldLabels: {
      title: "Milestone",
      subtitle: "Date / phase",
      body: "Description",
  ...
  trust_badges: {
    label: "Trust badges",
    actionLabel: "badges",
    fields: ["image_url", "title", "subtitle", "value"],
    fieldLabels: {
      image_url: "Logo / badge",
      title: "Label",
      subtitle: "Caption",
      value: "Fallback icon text",
    },
    preview: "benefit",
  },
  learning_path: {
    label: "Path steps",
    actionLabel: "steps",
    fields: ["value", "title", "subtitle", "body", "buttons"],
    fieldLabels: {
      value: "Step number",
      title: "Module",
