...
export default function CatalogSearch({
  ...
  return (
    ...
    >
      <label className="flex h-11 w-full items-center gap-2.5 rounded-lg border border-slate-200 bg-white px-3 focus-within:border-brand/40 focus-within:ring-2 focus-within:ring-brand/20 dark:border-slate-700 dark:bg-slate-950">
        <svg
