...
export type VendorCatalogRecord = {
  slug?: string;
  name?: string;
  logoUrl?: string;
...
export type ProductCatalogRecord = {
  ...
  description?: string;
  category?: string;
  vendor?: { name?: string; slug?: string } | string | null;
  [key: string]: unknown;
};

export type TaxonomyCatalogRecord = {
  name?: string;
  description?: string;
  [key: string]: unknown;
};

export function VendorCatalogCard({ vendor }: { vendor: VendorCatalogRecord }) {
