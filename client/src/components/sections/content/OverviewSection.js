      ...
      >
        ...
        <div className="order-2 flex min-w-0 flex-col gap-4 sm:gap-5">
          {section_title || cmsMode ? (
            ...
            >
              {section_title ? (
                <h2 className="m-0 font-[family-name:var(--font-display)] text-3xl leading-[1.12] font-semibold tracking-tight section-theme-heading sm:text-4xl">
                  {section_title}
                </h2>
              ) : (
          ...
          {sub_title || cmsMode ? (
            ...
            >
              {sub_title ? (
                <p className="m-0 max-w-2xl text-base leading-relaxed section-theme-muted">
                  {sub_title}
                </p>
              ) : (
