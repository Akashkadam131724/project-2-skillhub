...
import type {
  ...
  PresetGradientGridProps,
  PresetSolidRowProps,
  ToneSectionProps,
} from "./types";

function PresetSolidRow({ presets, current, onChange }: PresetSolidRowProps) {
  return (
...
function PresetGradientGrid({ presets, current, onChange }: PresetGradientGridProps) {
...
function ToneSection({ title, hint, solids, gradients, current, onChange }: ToneSectionProps) {
  return (
