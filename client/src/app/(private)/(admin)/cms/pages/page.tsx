...
import type { PageTemplateForm, PageTemplateRecord } from "../entity-types";
...
const emptyForm: PageTemplateForm = {
  key: "",
  name: "",
  description: "",
  entity_type: "",
...
export default function CmsPagesPage() {
  ...
  async function load() {
    ...
    try {
      ...
      setPages((res.data || []) as PageTemplateRecord[]);
    } catch (err) {
      setError(err);
    } finally {
      setLoading(false);
  ...
  async function onCreate(e: FormEvent) {
    ...
    try {
      ...
      setForm(emptyForm);
      setShowForm(false);
      router.push(`/cms/pages/${(res.data as PageTemplateRecord).key}`);
    } catch (err) {
      setError(err);
    } finally {
      setSaving(false);
  ...
  async function toggleStatus(page: PageTemplateRecord) {
    try {
  ...
  async function onDelete(page: PageTemplateRecord) {
