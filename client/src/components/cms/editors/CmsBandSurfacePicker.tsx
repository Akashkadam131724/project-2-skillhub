...
} from "@/lib/sections/section-band-surfaces";
import type { BandSurfacePreset, CmsBandSurfacePickerProps } from "./types";

function isActivePreset(preset: BandSurfacePreset, bgColor: string) {
...
function groupsForToneRole(tone: string | null, role: string) {
            ...
            {group.presets.map((preset) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  disabled={disabled}
                  title={"hint" in preset ? preset.hint || preset.label : preset.label}
                ...
                >
                  ...
                  {!compact && "hint" in preset && preset.hint ? (
